...
namespace DumpReader
{
    ...
    public class SMEMiniDumpReader
    {
        ...
        private MiniDumpExceptionStream m_exceptionstream;
        private MiniDumpModule[] m_module;
        private MiniDumpMiscInfo m_miscinfo;
        private MiniDumpBreakpadInfo m_breakpadinfo;
        private MiniDumpAssertionInfo m_assertioninfo;

        //Property
        public MiniDumpExceptionStream ExceptionStream
        {
            get { return m_exceptionstream; }
        }
        public MiniDumpModule[] Module
        {
            get { return m_module; }
        }
        public MiniDumpMiscInfo MiscInfo
        {
            get { return m_miscinfo; }
        }
        public MiniDumpBreakpadInfo BreakpadInfo
        {
            get { return m_breakpadinfo; }
        }
        public MiniDumpAssertionInfo AssertionInfo
        {
            get { return m_assertioninfo; }
        }
        ...
        public SMEMiniDumpReader(string filepath)
        {
            ...
            m_exceptionstream = this.ReadExceptionStream();
            m_miscinfo = this.ReadMiscInfo();
            m_module = this.ReadModuleList();
            m_breakpadinfo = this.ReadBreakpadInfo();
            m_assertioninfo = this.ReadAssertionInfo();
        }
