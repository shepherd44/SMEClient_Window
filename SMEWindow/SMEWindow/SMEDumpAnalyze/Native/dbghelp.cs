...
namespace SME.SMEDumpAnalyze.Native
{
    /*
...
typedef struct _MINIDUMP_UNLOADED_MODULE {
    ...
    //=========google_breakpad의 Additional Exception Information Define Structure =========//
    /*typedef struct {
      uint32_t validity;
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    internal struct MDRawBreakpadInfo
    {
        public UInt32 validity;
        public UInt32 dump_thread_id;
        public UInt32 requesting_thread_id;
    }
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 4)]
    public unsafe struct MDRawAssertionInfo
    {
        public fixed UInt16 expression[128];
        public fixed UInt16 function[128];
        public fixed UInt16 file[128];
        public UInt32 line;
        public UInt32 type;
    }
    //======================================================================================//
    ...
    public enum MINIDUMP_STREAM_TYPE : uint
    {
        ...
        //google_breakpad에서 지정한 USER_STREAM_TYPE
